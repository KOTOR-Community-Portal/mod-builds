...
* *If you are not installing on a Windows OS*, keep [this card](https://i.imgur.com/Zzot8du.png) in mind, as it goes over the various install types present in the builds and will help you determine what mods will be easy to install on your OS, and which might need special support (for instance, using a wrapper to install .exe files on Mac OS).
